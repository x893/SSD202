...
hal_SERFLASH_t _hal_SERFLASH_table[] =   // Need to Add more sample for robust
{
	...
	{ FLASH_IC_XM25QH128C,	MID_XMC,	    0x40,	0x18,	_pstWriteProtectTable_XM25QH128C,     NULL,                       0x1000000,  256,	  SIZE_64KB,  256,	  50,	 BITS(5:2, 0x0F),	 ISP_DEV_NEXTFLASH,	 ISP_SPI_ENDIAN_LITTLE, {E_SPI_86M  , E_DUAL_AD_MODE}, TRUE,   TRUE},
